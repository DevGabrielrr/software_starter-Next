      ...
      <div className="w-[90%] md:w-[90%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10">
        ...
        <div data-aos="fade-up">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-7xl mt-6 mb-6 font-bold text-white leading-[2.5rem] md:leading-[4rem] ">
            Providing software solutions for yuor any{" "}
          ...
          <p className="text-sm sm:text-base font-medium md:text-lg text-gray-300">
            ...
            error provident molestiae ducimus obcaecati? Id deleniti cupiditate
            sed.
          </p>
          {/* Button */}
          <a
            href="#_"
            className="relative inline-flex items-center justify-start mt-3 px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group "
          >
